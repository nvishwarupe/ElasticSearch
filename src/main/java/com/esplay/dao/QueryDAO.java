...
public class QueryDAO {
    ...
    * @param document
    * @return
    * index name is name of database and type is name of the table
    */
   public String createIndex(Movie movie, String indexName, String type){

       try {
           IndexRequest request = new IndexRequest(indexName, type);
           request.source(gson.toJson(movie), XContentType.JSON);
